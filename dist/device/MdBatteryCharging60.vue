<script>
  export default {
    name: 'md-battery-charging-60',

    serverCacheKey: props => {
      return `md-battery-charging-60:${props.color || 'default'}:${props.width}:${props.height}:${props.className || 'icon'}`;
    },
    ...
    render (h) {
      const data = {
        staticClass: 'icon md-icon md-battery-charging-60',
