<script>
  export default {
    name: 'md-sentiment-satisfied',

    serverCacheKey: props => {
      return `md-sentiment-satisfied:${props.color || 'default'}:${props.width}:${props.height}:${props.className || 'icon'}`;
    },
    ...
    render (h) {
      const data = {
        staticClass: 'icon md-icon md-sentiment-satisfied',
