<script>
  export default {
    name: 'md-linked-camera',

    serverCacheKey: props => {
      return `md-linked-camera:${props.color || 'default'}:${props.width}:${props.height}:${props.className || 'icon'}`;
    },
    ...
    render (h) {
      const data = {
        staticClass: 'icon md-icon md-linked-camera',
